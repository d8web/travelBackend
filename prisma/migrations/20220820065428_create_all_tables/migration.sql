...
CREATE TABLE "attractives" (
    ...
    "openVisits" BOOLEAN DEFAULT true,
    "historicalHeritage" BOOLEAN DEFAULT false,
    "observations" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "user_favorites" ADD CONSTRAINT "user_favorites_idAttractive_fkey" FOREIGN KEY ("idAttractive") REFERENCES "attractives"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
